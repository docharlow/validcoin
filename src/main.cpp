...
unsigned int nTargetSpacing_v2 = 90; // 1min 30s
unsigned int nStakeMinAge = 60 * 60 * 168; //168h
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ValidCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Valideum - Blockchain Contract Law - by healkiller";
        CTransaction txNew;
        txNew.nTime = 1543063865;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1543063865;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 2085587 : 2085587;
        ...
        assert(block.hashMerkleRoot == uint256("0xc4b0796895a4e98ceccb81f912ec7459aeda22684758f51fc8b72321334a83f0"));
